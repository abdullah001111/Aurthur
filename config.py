...
# Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6132146327:AAGvIZLcwdkWokeC8JeFsDi9SI2_Mt5cFhI")
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Aurthur:Aurthur@cluster0.sxryu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Arthur")

# Force sub channel id, if you want enable force sub
FORCE_CHANNEL = int(os.environ.get("FORCE_CHANNEL", "-1002120887442"))
FORCE_CHANNEL2 = int(os.environ.get("FORCE_CHANNEL2", "-1001931744144"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

# Mainly add graph else telegraph link
START_PIC = os.environ.get("START_PIC", "https://telegra.ph/file/a5e5efcd8523472dd594c.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://telegra.ph/file/a5e5efcd8523472dd594c.jpg")
