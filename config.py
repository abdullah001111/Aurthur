...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Leech:Leech@cluster0.fbcoxxr.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "Leech")
